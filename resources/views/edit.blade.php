...
<div class="container">
    <div class="form-group col-12 p-0">
	    ...
	    <div class="container">
            ...
            <input type="text" placeholder="Enter Email" name="email" value="{{$data['email']}}"required>
            ...
            <input type="text" placeholder="Enter Password" name="password" value="{{$data['password']}}"required>
            <span class="text-danger">@error('password') {{ $message }}@enderror</span>
            <label for="psw-repeat"><b>Repeat Password</b></label>
            <input type="password" placeholder="Repeat Password" name="psw1" value="{{$data['password']}}" required>
            <label for="Date Of Birth"><b>Date Of Birth</b><br/></label>
            <input type="date" placeholder="Select date of birth" name="dob" value="{{$data['dob']}}" required>
            <br/><br/>
            ...
            <Button class="btn-btn-success" onclick="val()" style="width:80px;" type="submit">Update</Button>
        </div>
        </form>
  </div>
</div>
